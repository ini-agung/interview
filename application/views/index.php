    ...
    <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header d-flex align-items-center">
                <a class="navbar-brand" href="<?= base_url('assets/argon/pages/dashboards/dashboard.html') ?>">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <div class="collapse show" id="navbar-dashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/dashboards/dashboard.html') ?>" class="nav-link">Dashboard</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/dashboards/alternative.html') ?>" class="nav-link">Alternative</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-examples">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/pricing.html') ?>" class="nav-link">Pricing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/login.html') ?>" class="nav-link">Login</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/register.html') ?>" class="nav-link">Register</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/lock.html') ?>" class="nav-link">Lock</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/timeline.html') ?>" class="nav-link">Timeline</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/examples/profile.html') ?>" class="nav-link">Profile</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-components">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/buttons.html') ?>" class="nav-link">Buttons</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/cards.html') ?>" class="nav-link">Cards</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/grid.html') ?>" class="nav-link">Grid</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/notifications.html') ?>" class="nav-link">Notifications</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/icons.html') ?>" class="nav-link">Icons</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/components/typography.html') ?>" class="nav-link">Typography</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-forms">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/forms/elements.html') ?>" class="nav-link">Elements</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/forms/components.html') ?>" class="nav-link">Components</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/forms/validation.html') ?>" class="nav-link">Validation</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-tables">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/tables/tables.html') ?>" class="nav-link">Tables</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/tables/sortable.html') ?>" class="nav-link">Sortable</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/tables/datatables.html') ?>" class="nav-link">Datatables</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="navbar-maps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/maps/google.html') ?>" class="nav-link">Google</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('assets/argon/pages/maps/vector.html') ?>" class="nav-link">Vector</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('assets/argon/pages/widgets.html') ?>">
                                <i class="ni ni-archive-2 text-green"></i>
                                <span class="nav-link-text">Widgets</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('assets/argon/pages/charts.html') ?>">
                                <i class="ni ni-chart-pie-35 text-info"></i>
                                <span class="nav-link-text">Charts</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('assets/argon/pages/calendar.html') ?>">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-1.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col ml--2">
                                            <h4 class="mb-0">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-2.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col ml--2">
                                            <h4 class="mb-0">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-3.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col ml--2">
                                            <h4 class="mb-0">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/bootstrap.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/angular.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/sketch.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <a href="#" class="avatar rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/react.jpg') ?>">
                                            </a>
                                        </div>
                                        <div class="col">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <a href="#">
                                    <img src="<?= base_url('assets/argon/assets/img/theme/team-1.jpg') ?>" class="avatar">
                                </a>
                                <div class="mx-3">
                        ...
                        <div class="card-body">
                            ...
                            <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/img-1-1000x600.jpg') ?>" class="img-fluid rounded">
                                    ...
                                    <div class="d-flex align-items-center justify-content-sm-end">
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Jessica Rowland">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-1.jpg') ?>" class="">
                                            </a>
                                            <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Audrey Love">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-2.jpg') ?>" class="rounded-circle">
                                            </a>
                                            <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Michael Lewis">
                                                <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/team-3.jpg') ?>" class="rounded-circle">
                                            </a>
                                        </div>
                            ...
                            <div class="mb-1">
                                <div class="media media-comment">
                                    <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?= base_url('assets/argon/assets/img/theme/team-1.jpg') ?>">
                                ...
                                <div class="media media-comment">
                                    <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?= base_url('assets/argon/assets/img/theme/team-2.jpg') ?>">
                                    <div class="media-body">
                                        <div class="media-comment-text">
                                ...
                                <hr />
                                <div class="media align-items-center">
                                    <img alt="Image placeholder" class="avatar avatar-lg rounded-circle mr-4" src="<?= base_url('assets/argon/assets/img/theme/team-3.jpg') ?>">
                                    <div class="media-body">
                                        <form>
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="media align-items-center">
                                                        <a href="#" class="avatar rounded-circle mr-3">
                                                            <img alt="Image placeholder" src="<?= base_url('assets/argon/assets/img/theme/vue.jpg') ?>">
                                                        </a>
                                                        <div class="media-body">
                        ...
                        <div class="card bg-gradient-danger">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col">
                                        <img src="<?= base_url('assets/argon/assets/img/icons/cards/bitcoin.png') ?>" alt="Image placeholder" />
                                    </div>
                                    <div class="col-auto">
